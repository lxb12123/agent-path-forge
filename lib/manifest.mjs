...
const GENE_DIR = '.gene';
const MANIFEST = 'gene.json';   // machine-readable manifest in JSON (Node-native, zero dependencies)
...
export function readManifest(targetDir) {
  ...
  catch { loaded = {}; }   // empty/corrupt manifest → normalize to an empty manifest, don't crash
