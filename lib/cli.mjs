...
// CLI: node lib/cli.mjs inherit|scaffold|eval <dir> [--name <name>] [--from <skillDir>] [--runs <runsFile>]
...
if (isMain()) {
  ...
  if (cmd === 'inherit') {
    ...
    console.error('usage: geneprint <inherit|scaffold|eval> <dir> [--name <name>] [--from <skillDir>] [--runs <runsFile>]');
    process.exit(1);
  }
}
